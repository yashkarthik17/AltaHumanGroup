...
import { ChevronDown, BookOpen, Scale, Landmark, Users, Mic2, AlertTriangle, Fingerprint, Clapperboard, Medal, Sword, Shield, Home, Vote, Heart, Briefcase, GraduationCap, Megaphone } from 'lucide-react';
                  ...
                  <div className="p-8 pt-0 md:p-10 md:pt-0 pl-[5.5rem] md:pl-[6.5rem]">
                    <div className="flex flex-col md:flex-row gap-8">
                      ...
                      <div className="w-full md:w-1/3">
                        <div className="aspect-[3/4] overflow-hidden rounded-sm bg-gray-100 relative sticky top-8">
